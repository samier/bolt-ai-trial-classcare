...
@Component({
  selector: 'app-faculty-requisition-list',
  templateUrl: './faculty-requisition-list.component.html',
  styleUrls: ['./faculty-requisition-list.component.scss']
})
export class FacultyRequisitionListComponent implements OnInit {
  ...
  constructor(private inventorySerivce:InventoryService,private modalService: NgbModal,  public CommonService: CommonService){
  }
  ...
  loadData(dataTablesParameters?: any, callback?:any ){
    Object.assign(dataTablesParameters,{for:'faculty'});
    this.inventorySerivce.getRequisitionListForFaculty(dataTablesParameters).subscribe((resp:any) => {
