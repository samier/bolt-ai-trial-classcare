...
export class KitListComponent {
  ...
  constructor(private inventorySerivce:InventoryService,private modalService: NgbModal,  public CommonService: CommonService, private toastr: Toastr){
  }
  URLConstants=URLConstants;
      ...
      /// to display requisition informations
        open2(content:any,id:any) {
          this.inventorySerivce.getKitFullDetail(id).subscribe((res:any) => {      
            this.kit_modal_data=res.data;
  ...
  loadData(dataTablesParameters?: any, callback?:any ){
    this.inventorySerivce.getKitList(dataTablesParameters).subscribe((resp:any) => {
  ...
  delete(id:number){
    ...
    if(c){
      this.inventorySerivce.deleteKit(id).subscribe((res:any) => {      
        if(res.status){
