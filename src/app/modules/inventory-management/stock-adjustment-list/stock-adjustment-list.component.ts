...
export class StockAdjustmentListComponent {
  ...
  URLConstants=URLConstants;
      ...
      /// to display requisition informations
        open2(content:any,id:any) {
          this.inventorySerivce.getStockAdjustmentFullDetail(id).subscribe((res:any) => {      
  ...
  loadData(dataTablesParameters?: any, callback?:any ){
    this.inventorySerivce.getStockAdjustmentList(dataTablesParameters).subscribe((resp:any) => {
  ...
  delete(id:number){
    ...
    if(c){
      this.inventorySerivce.deleteStockAdjustment(id).subscribe((res:any) => {      
        console.log(res); 
        this.reloadData();
      });             
    }
