...
@Component({
  selector: 'app-payroll-group-view',
  templateUrl: './payroll-group-view.component.html',
  styleUrls: ['./payroll-group-view.component.scss']
})
export class PayrollGroupViewComponent {
